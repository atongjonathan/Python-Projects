...
checkmark_label = Label(fg=GREEN, bg=YELLOW, font=("Arial", 12, "bold"), highlightthickness=0)
checkmark_label.grid(column=2, row=3)

start_button = Button(text="Start", highlightthickness=0, command=start_timer)
start_button.grid(column=1, row=3)

reset_button = Button(text="Reset", highlightthickness=0, command=stop_timer)
